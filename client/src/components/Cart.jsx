    ...
    <aside className="cart" aria-labelledby="cart-title">
      ...
      {items.length === 0 ? (
        <div className="empty-cart">
          ...
          <small>Add something fresh from the menu.</small>
        </div>
      ) : (
        <>
              ...
              <li key={item._id}>
                ...
                <div className="quantity">
                  <button
                    ...
                    onClick={() => onChange(item._id, item.quantity - 1)}
                  >
                    −
                  </button>
          ...
          <button className="primary wide checkout-button" onClick={onCheckout}>
