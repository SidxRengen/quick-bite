    ...
    <section className="admin-form-card">
      ...
      <form onSubmit={onSubmit}>
        <div className="form-grid">
          <TextField label="Item name" name="name" value={value.name} onChange={updateField} maxLength={80} />
          <TextField label="Category" name="category" value={value.category} onChange={updateField} maxLength={50} />
          <TextField label="Price (₹)" name="price" value={value.price} onChange={updateField} type="number" min="0" max="100000" step="0.01" />
          <TextField label="Image URL" name="image" value={value.image} onChange={updateField} type="url" />
        </div>
