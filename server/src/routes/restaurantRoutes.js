...
import { listRestaurantOrders, loginRestaurant, patchRestaurantOrderStatus } from '../controllers/restaurantController.js';
...
restaurantRoutes.patch('/orders/:id/status', validateObjectId, patchRestaurantOrderStatus);
